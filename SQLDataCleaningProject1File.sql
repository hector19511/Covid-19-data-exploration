...
/*
Description:
the following code was used to clean a raw data set by removing duplicates, standardyzing data, removing some null and blank values and removing unnecesary columns.
the dataset was taken from the following link: https://github.com/AlexTheAnalyst/MySQL-YouTube-Series/blob/main/layoffs.csv
*/
